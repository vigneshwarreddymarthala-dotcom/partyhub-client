...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-500 text-sm mb-10">Last updated: June 16, 2026</p>
      ...
      <div className="space-y-8 text-gray-400 text-sm leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            ...
            <li><strong className="text-gray-300">Push notification token</strong>: a device token generated by Expo when you grant notification permission on the mobile app, used solely to deliver chat message alerts to your device</li>
          </ul>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>To send push notifications to your device when someone sends a message in an event chat room you are part of</li>
        ...
        <section>
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            ...
            <li><strong className="text-gray-300">Expo Push Notification Service</strong> — delivers push notifications to your device using your push token; Expo does not store message content</li>
          </ul>
